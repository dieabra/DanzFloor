$(document).ready(function () {
    //Basic Example
    var entidadGrilla = 'diaNoLaborable';
        ...
        formatters: {
            "commands": function (column, row) {
                commands = "<a type=\"button\" class=\"btn btn-icon command-edit waves-effect waves-circle\" href=\"/" + entidadGrilla + "/Edit/" + row.Id.trim() + "\"><span class=\"zmdi zmdi-edit\"></span></a> " +
                        "<a type=\"button\" caller-method=\"" + entidadGrilla + "\" caller-nombre=\"el Día No Laboral\" caller-parameter=\"" + row.Id.trim() + "\" class=\"btn btn-icon command-delete waves-effect waves-circle\"><span class=\"zmdi zmdi-delete\"></span></a>";
                return commands;
            }
        },
        searchSettings: {
