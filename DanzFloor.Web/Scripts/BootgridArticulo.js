        ...
        formatters: {
            "commands": function (column, row) {
                ...
                if (row.Producto.trim() == "")
                    commands = commands + "<a type=\"button\" class=\"btn btn-icon command-edit waves-effect waves-circle\" href=\"/Producto/Create/?articuloId=" + row.Id.trim() + "\"><span class=\"zmdi zmdi-plus\"></span></a> ";
                return commands;
            }
        },
        searchSettings: {
