$(document).ready(function () {
    //Basic Example
    var descripcion = 'Destacado';
    var entidadGrilla = 'destacado';
        ...
        formatters: {
            "commands": function (column, row) {
                commands = "<a type=\"button\" class=\"btn btn-icon command-edit waves-effect waves-circle\" href=\"/" + entidadGrilla + "/Edit/" + row.Id.trim() + "\"><span class=\"zmdi zmdi-edit\"></span></a> " +
                    ...
                    "<a type=\"button\" class=\"btn btn-icon command-edit waves-effect waves-circle\" href=\"/Frontend/Index/?destacadoId=" + row.Id.trim() + "\"><span class=\"zmdi zmdi-eye\"></span></a> ";
                return commands;
            }
        },
        searchSettings: {
