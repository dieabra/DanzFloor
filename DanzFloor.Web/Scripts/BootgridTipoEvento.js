$(document).ready(function () {
    ...
    $("#data-table-basic-" + entidadGrilla).bootgrid({
        ...
        var callerMethod = function () {
            ...
            swal({
                title: "¿Está seguro de que desea eliminar el Tipo de Evento?",
                type: "warning",
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        swal("¡Eliminado!", "El Tipo de Evento fue eliminada.", "success");
                        window.location.assign(window.location.origin + '/' + entidad);
                    },
                    error: function (error) {
                        swal("¡Ups!", "El Tipo de Evento no fue eliminada.", "error");
                    }
                });
            });
        }
